...
public class HamburgStreetTreeLz4FastImpl extends HamburgStreetTreeByteImpl {
    ...
    public HamburgStreetTreeLz4FastImpl(final String gmlId,
    ...
    protected byte[] preSave(byte[] storage) {
        ...
        return LZ4_FACTORY.fastCompressor().compress(storage);
    }
